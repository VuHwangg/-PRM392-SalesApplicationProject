...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Message_DTO> chatMessageList;
    private String sendid;
    private static  final  int TYPE_SEND =1;
    private static  final  int TYPE_RECEIVED =2;

    public ChatAdapter(Context context, List<Message_DTO> chatMessageList, String sendid) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_SEND){
            view = LayoutInflater.from(context).inflate(R.layout.item_sendmessage,parent,false);
    ...
    class SendMessViewHolder extends  RecyclerView.ViewHolder{
        ...
        public SendMessViewHolder(@androidx.annotation.NonNull View itemView) {
            super(itemView);
